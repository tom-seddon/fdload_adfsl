...
in, giving access to the fdload_init_code region. The previous values
of ACCCON and ROMSEL are saved beforehand and will be restored.
Preserve A and C.
...
So that covers up to about $210? And $0258 is already reserved. Might
as well book $0211-$0257? Some of that stuff could go in page $01, but
...
| $0207    |                        |                                  |
| $0208    | irq_set_handler        | resident entry point             |
| $0209    |                        |                                  |
| $020a    | irq_reset_handler      | resident entry point             |
| $020b... |                        | any resident stuff               |
