...
Supply =--zx02-quick= to =boot_builder= to have it run zx02 in quick
mode, whether run on demand or as part of =warm-zx02-cache=. zx02
quick mode is much faster, but the compression isn't as good.

Files are found in the zx02 cache based on their uncompressed
contents: only files that are changing from build to build need to get
recompressed, and existing cache entries will be found however they
were compressed. An occasional full rebuild without =--zx02-quick=
will fill the cache with better-compressed copies of any files that
aren't currently being iterated on.
...
*** =fdload_banked_version=, =fdload_working_code=, =fdload_select_bank=
...
=fdload_select_bank= is a macro that expands to code to select the
banked region that fdload is stored in, giving access to the
fdload_init_code region. The assumption is that this will just set
specific ACCCON and ROMSEL bits (and won't be executed anywhere where
this would cause a problem). The previous values of ACCCON and ROMSEL
are saved beforehand and will be restored. Must preserve Y and C.
...
Zero page: (free if not otherwise stated)
...
Wider main memory use: (free if not otherwise stated)
...
=fdload_select_bank= needs to be in main RAM.

So that covers up to about $209? And $0258 is already reserved. Might
as well book $0209-$0257? Some of that stuff could go in page $01, but
it'd be nice to leave the entire stack free.
...
| $0204    | IRQ1V LSB              |                                  |
| $0205    | IRQ1V MSB              |                                  |
| $0206    | irq_set_handler        | resident entry point             |
| $0207    |                        |                                  |
| $0208    | irq_reset_handler      | resident entry point             |
| $0209... |                        | any resident stuff               |
...
main RAM and make additional fdload entry points available.
...
https://bbc.godbolt.org/?&disc=https://raw.githubusercontent.com/tom-seddon/tom-seddon.github.io/483c0baf4d03cf71c203bd05aba8a9d974fa25e7/demo_disk.adl&autoboot&model=MasterADFS

* previous prototypes

- 5 scrollers :: https://bbc.godbolt.org/?&disc=https://raw.githubusercontent.com/tom-seddon/tom-seddon.github.io/483c0baf4d03cf71c203bd05aba8a9d974fa25e7/scroll-4x.ssd&autoboot&model=Master
- roto zoom :: https://bbc.xania.org/?&disc=https://raw.githubusercontent.com/tom-seddon/tom-seddon.github.io/483c0baf4d03cf71c203bd05aba8a9d974fa25e7/rotozoom.ssd&autoboot&model=Master
- palette-based text scroller :: https://bbc.xania.org/?&disc=https://raw.githubusercontent.com/tom-seddon/tom-seddon.github.io/483c0baf4d03cf71c203bd05aba8a9d974fa25e7/scroll-palette.ssd&autoboot&model=Master

Shadow RAM cutout plus big sprite:

- static sprite, text behind :: https://bbc.xania.org/?&disc=https://raw.githubusercontent.com/tom-seddon/tom-seddon.github.io/483c0baf4d03cf71c203bd05aba8a9d974fa25e7/scroll-cutout-masked.ssd&autoboot&model=Master
- moving sprite, text in front, "transparency" :: https://bbc.xania.org/?&disc=https://raw.githubusercontent.com/tom-seddon/tom-seddon.github.io/483c0baf4d03cf71c203bd05aba8a9d974fa25e7/scroll-cutout-moving.ssd&autoboot&model=Master
- static sprite, text in front, "transparency" :: https://bbc.xania.org/?&disc=https://raw.githubusercontent.com/tom-seddon/tom-seddon.github.io/483c0baf4d03cf71c203bd05aba8a9d974fa25e7/scroll-cutout-transparency.ssd&autoboot&model=Master
- static sprite, text in front :: https://bbc.xania.org/?&disc=https://raw.githubusercontent.com/tom-seddon/tom-seddon.github.io/483c0baf4d03cf71c203bd05aba8a9d974fa25e7/scroll-cutout.ssd&autoboot&model=Master

Balls:

- 7, spinning, solid colour :: https://bbc.xania.org/?&disc=https://raw.githubusercontent.com/tom-seddon/tom-seddon.github.io/483c0baf4d03cf71c203bd05aba8a9d974fa25e7/balls.ssd&autoboot&model=Master
- 7, spinning, dithered :: https://bbc.xania.org/?&disc=https://raw.githubusercontent.com/tom-seddon/tom-seddon.github.io/483c0baf4d03cf71c203bd05aba8a9d974fa25e7/balls-dither.ssd&autoboot&model=Master
- 7, animated, solid colour :: https://bbc.xania.org/?&disc=https://raw.githubusercontent.com/tom-seddon/tom-seddon.github.io/483c0baf4d03cf71c203bd05aba8a9d974fa25e7/balls-anim.ssd&autoboot&model=Master
- 8, animated, solid colour :: https://bbc.xania.org/?&disc=https://raw.githubusercontent.com/tom-seddon/tom-seddon.github.io/483c0baf4d03cf71c203bd05aba8a9d974fa25e7/8balls.ssd&autoboot&model=Master
